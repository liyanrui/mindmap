...
In the example above, \type{MM.BEGIN} and \type{MM.END} both are the module parameters. They delimit the segment of a branch where annotation text may appear; the text is restricted to the interval [\type{MM.BEGIN}, \type{MM.END}] along that branch. The segment [0, 1] represents the entire branch.
